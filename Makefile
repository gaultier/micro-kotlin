...
main_debug: main.c class_file.h
	ASAN_OPTIONS=abort_on_error=1:halt_on_error=1 UBSAN_OPTIONS=abort_on_error=1:halt_on_error=1 $(CC) -DPG_WITH_LOG=1 -O0 -g3 -Wall -Wextra -std=c99 -fsanitize=address,undefined -fsanitize-trap=undefined $< -o $@ 
