...
main_debug: main.c class_file.h
	ASAN_OPTIONS=abort_on_error=1:halt_on_error=1 UBSAN_OPTIONS=abort_on_error=1:halt_on_error=1 $(CC) -DPG_WITH_LOG=1 -O0 -g3 -Weverything -Wno-padded -std=c99 -Wno-declaration-after-statement -Wno-missing-prototypes -fsanitize=address,undefined -fsanitize-trap=undefined $< -o $@ 
