...
int main() {
  ...
  const u16 constant_java_lang_object_string_i =
      cf_add_constant_cstring(&class_file, "java/lang/Object");

  const u16 constant_void_method_descriptor_string_i =
      cf_add_constant_cstring(&class_file, "()V");

  const u16 constant_class_object_name_and_type_name_i =
      cf_add_constant_cstring(&class_file, "<init>");
  ...
  const u16 constant_class_object_i =
      cf_add_constant(&class_file, &constant_class_object);
  ...
  const u16 constant_class_object_name_and_type_i =
      cf_add_constant(&class_file, &constant_class_object_name_and_type);
  ...
  const u16 constant_object_method_ref_constructor_i =
      cf_add_constant(&class_file, &constant_object_method_ref_constructor);

  const u16 constant_this_class_name_i =
      cf_add_constant_cstring(&class_file, "PgMain");
  ...
  const u16 constant_this_class_i =
      cf_add_constant(&class_file, &constant_this_class);
  class_file.this_class = constant_this_class_i;

  const u16 constant_string_code_i =
      cf_add_constant_cstring(&class_file, "Code");

  const u16 constant_string_line_number_table_i =
      cf_add_constant_cstring(&class_file, "LineNumberTable");

  const u16 constant_string_main_i =
      cf_add_constant_cstring(&class_file, "main");

  const u16 constant_string_main_type_descriptor_i =
      cf_add_constant_cstring(&class_file, "([Ljava/lang/String;)V");

  const u16 constant_string_source_file_i =
      cf_add_constant_cstring(&class_file, "SourceFile");

  const u16 constant_string_file_i =
      cf_add_constant_cstring(&class_file, "PgMain.java");

  const u16 constant_string_java_lang_system_class_i =
      cf_add_constant_cstring(&class_file, "java/lang/System");
  const cf_constant_t constant_java_lang_system_class_info = {
      .kind = CIK_CLASS_INFO,
      .v = {.class_name = constant_string_java_lang_system_class_i}};
  const u16 constant_java_lang_system_class_info_i =
      cf_add_constant(&class_file, &constant_java_lang_system_class_info);

  const u16 constant_string_out_i = cf_add_constant_cstring(&class_file, "out");

  const u16 constant_string_java_io_printstream_i =
      cf_add_constant_cstring(&class_file, "java/io/PrintStream");
  ...
  const u16 constant_string_java_io_printstream_class_i =
      cf_add_constant(&class_file, &constant_string_java_io_printstream_class);

  const u16 constant_string_java_io_printstream_descriptor_i =
      cf_add_constant_cstring(&class_file, "Ljava/io/PrintStream;");
  ...
  const u16 constant_out_name_and_type_i =
      cf_add_constant(&class_file, &constant_out_name_and_type);
  ...
  const u16 constant_out_fieldref_i =
      cf_add_constant(&class_file, &constant_out_fieldref);
  ...
  const u16 constant_string_hello_i =
      cf_add_constant_cstring(&class_file, "Hello, world!");
  const u16 constant_jstring_hello_i =
      cf_add_constant_jstring(&class_file, constant_string_hello_i);

  const u16 constant_string_println_i =
      cf_add_constant_cstring(&class_file, "println");
  ...
  const u16 constant_println_name_and_type_i =
      cf_add_constant(&class_file, &constant_println_name_and_type);
  ...
  const u16 constant_println_method_ref_i =
      cf_add_constant(&class_file, &constant_println_method_ref);
